...
//    List<QualityRange> findByMaterialMaster_MaterialNameAndMaterialTypeMaster_MaterialTypeName(String materialName, String materialTypeName);

    List<QualityRange> findByMaterialMasterMaterialName(String materialName);
}
